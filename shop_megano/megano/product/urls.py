...
urlpatterns = [
    ...
    path(
        "api/products/popular/", PopularProductsList.as_view(), name="popular-products"
    ),
    path(
        "api/products/limited/", LimitedEditionList.as_view(), name="limited-products"
    ),
    path("api/product/<int:pk>/", ProductDetails.as_view(), name="product-details"),
    path(
        "api/product/<int:pk>/reviews",
        ReviewCreateProduct.as_view(),
        name="review-create",
    ),
