...
def category_image_directory_path(instance: "CategoryImage", filename) -> str:
    ...
    if instance.category.parent:
        ...
        return f"categories/" f"category_{instance.category.pk}/" f"{filename}"
...
def product_images_directory_path(instance: "ProductImage", filename: str) -> str:
    ...
    :return:
    """
    return f"products/" f"product_{instance.product.pk}/" f"{filename}"
...
class Product(models.Model):
    ...
    price = models.DecimalField(
        default=1, max_digits=8, decimal_places=2, null=False
    )  # цена
    count = models.IntegerField(default=1, null=False)  # количество
    rating = models.DecimalField(
        default=0, max_digits=5, decimal_places=2, null=False
    )  # рейтинг продукта
